...
// Identity 1: sin²θ + cos²θ = 1
        ...
        if (Math.abs(leftSide3 - rightSide3) < tolerance) {
            ...
            //I can extend it by adding more if else statements and increasing the tolerance if necessary to account for the increased potential for floating-point errors
        }
    }
