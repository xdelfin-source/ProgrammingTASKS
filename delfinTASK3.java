...
public class delfinTASK3 {
            ...
            try {// I also used a try-catch block to "catch" any errors. Its basically a "plan B" of some sort because if an error occurs, instead of crashing, the program looks for another way to execute that code
                ...
                switch (choice) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        problem3RightTriangle();
                        break;
                    case 4:
                        problem4TrigoIdentityVerify();
                        break;
                    case 5:
                        problem5WaveProperties();
                        break;
                    case 6:// when the user chooses choice number 6, the program will stop the loop and stop itself from continuing further
                        running = false;
                    ...
                    InputMismatchException e) {// The program detects an illegal input, like a letter or character for example. since its on a loop, this will notify the user and then they can choose again.
    ...
    public static void problem2AngleQFC() {
        ...
        // Using a nested if-else to handle special cases for angles on the axes.
        if (normalizedAngle == 0 || normalizedAngle == 360) {
            ...
            // Using a switch statement for the four main quadrants.
            int quadrantNumber;
            if (normalizedAngle > 0 && normalizedAngle < 90) {
                ...
                quadrantNumber = 3;
            } else { // normalizedAngle > 270 && normalizedAngle < 360
                quadrantNumber = 4;
            }
    ...
    public static void problem3RightTriangle() {
        ...
        switch (choice) {
            case 1:
                ...
                int sideChoice1 = scanner.nextInt();
                ...
                switch (sideChoice1) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        System.out.println("Invalid side choice. Please enter a valid number from 1 to 3.");
                        return;
                }
                break;
            case 2:
                ...
                System.out.print("Enter your choice (1-3): ");
                int sideChoice2 = scanner.nextInt();
...
// Identity 1: sin²θ + cos²θ = 1
                ...
                System.out.printf("\nVerifying sin²θ + cos²θ = 1\n").printf("Left side: %.10f\n", leftSide1).printf("Right side: 1.0\n");
            ...
            case 3:
                ...
                if (Math.abs(leftSide3 - rightSide3) < tolerance) {
                    ...
                    System.out.printf("Identity does not hold. Difference:\n", Math.abs(leftSide3 - rightSide3));
                }
                break;
            default:
                System.out.println("Invalid choice. Please enter a valid choice from 1 to 3.");
        ...
        //problem 5
    //the if else statement is more appropriate in this problem than the switch because the code is checking for float-point values that are very close to a specific number. Switch statements cannot handle this kind of approximate comparison of tolerance
